...
from typing import cast, Callable, Optional, Protocol, Sequence, Any
import argparse

from argcomplete.completers import BaseCompleter

from ..config import GlobalConfig
from ..ruyipkg.list_filter import ListFilter
...
def package_completer_builder(
    ...
    from ..ruyipkg.pkg_cli import AugmentedPkg  # pylint: disable=import-outside-toplevel
